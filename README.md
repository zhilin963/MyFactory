...
<a name="desc"></a>
## 1. Description
**My Factory** is an Android mobile application, mainly applied to a smart factory, aiming to monitor devices in real time. In case of device failure, the system records details and notifies the user. After then, the user can contact maintenance personnel, check the status of the device, and locate the device through the system.
...
* All relevant data of the devices are monitored in real time (temperature, online/offline, voltage, etc.).
